...
//builder.Services.AddSqliteCollection<string, IngestedChunk>("data-chatappsales-chunks", vectorStoreConnectionString);
//builder.Services.AddSqliteCollection<string, IngestedDocument>("data-chatappsales-documents", vectorStoreConnectionString);
